...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Оплата подписчиков идёт напрямую в подключенный платежный провайдер. PayGate выдаёт доступ, показывает статусы подписок и автоматизирует исключение по правилам.",
    siteName: "PayGate"
  },
  twitter: {
