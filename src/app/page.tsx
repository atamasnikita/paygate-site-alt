...
const FAQ = [
  ...
  { q: "Кого исключает бот?", a: "Только тех пользователей, у которых закончилась подписка и истёк грейс‑период (24 часа)." },
  {
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-4 pt-16 pb-14 sm:pt-20 sm:pb-16">
          ...
          <h1 className="mt-6 text-3xl sm:text-4xl md:text-[52px] md:leading-[1.05] font-semibold tracking-tight text-slate-900">
            PayGate — монетизация закрытых Telegram‑каналов
            <span className="mt-3 block text-base sm:text-lg font-normal text-slate-600">
              Оплата → ссылка на вступление → автоматическое отключение доступа
            </span>
          </h1>
