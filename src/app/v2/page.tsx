...
const PILLARS = [
  ...
  },
  {
    ...
    text: "Robokassa подключается на стороне владельца канала. PayGate не хранит данные карт и не становится промежуточной кассой."
  },
  {
...
const PRODUCT_BLOCKS = [
  ...
  },
  {
    ...
    text: "Публичная страница под Robokassa с документами, условиями и PDF-оффертой."
  },
  {
