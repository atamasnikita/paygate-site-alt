...
const FEATURES = [
  ...
  },
  {
    ...
    text: "Три обязательных шага: ресурс, тариф, платежный провайдер. Витрину для модерации можно включить дополнительно, если нет своего сайта."
  },
  {
...
const FAQ = [
  {
    q: "Нужен ли сайт для запуска?",
    a: "Сайт не обязателен. Если свой сайт уже есть, можно использовать его. Если сайта нет, включите витрину на mydopusk.ru с офертой и возвратами."
  },
  {
    ...
    <div ref={pageRef} className={styles.page}>
          ...
          <div className="grid grid-cols-1 gap-9 lg:grid-cols-[1.06fr_0.94fr] lg:gap-12">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-slate-700 sm:text-lg">
                Монетизация контента в Telegram без лишней рутины. Подписчик платит, бот выдает доступ и следит за исключениями. Если собственного
                сайта нет, можно включить витрину с офертой и возвратами на mydopusk.ru. Деньги поступают напрямую к вам через платежный провайдер.
              </p>
      ...
      <section id="how-it-works" ref={journeyRef} className="mx-auto max-w-6xl px-4 py-14 sm:py-16">
        ...
        <Reveal delay={80}>
          <div className={styles.journeyStorefrontHint}>
            Витрина в mini app не обязательна: если сайта нет, используйте ее как публичную ссылку продавца с офертой и правилами возврата.
          </div>
        </Reveal>
      ...
      <section id="storefront-demo" className="mx-auto max-w-6xl px-4 py-14 sm:py-16">
        <SectionHead
          ...
          text="Если отдельного сайта нет, витрина, оферта и правила возврата уже готовы. Ссылку можно использовать для модерации в платежной системе."
        />
